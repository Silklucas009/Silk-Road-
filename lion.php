 ...
 * @version : 2.8
 * Additional Coding by L51-505. June-6-2018
**/
...
$leaf['version']="2.8 - Extra coded by L51-505|#4n0n1m0x";
...
for($i=0; $i<$ln; $i++){
	...
	$text = str_replace("[-base64encodeemail-]", $lol2, $text);
...
print '
<head>
    <title>'.str_replace("www.", "", $_SERVER['HTTP_HOST']).' - Lion-Mailer</title>
    ...
    <div class="col-lg-6"><br>
        ...
        <div id="well" class="well well">
            ...
            <ul>
				...
				<li>[-date-] : <b>Date</b> ('.date("m/d/Y").')</li>
                ...
                <li>[-base64encodeemail-] : <b>Encodes email in Base64 </b></li>
            ...
            <ul>
                ...
                <li>Your result is  <b>[-base64encodeemail-]</b> -> Your result is <b>93uju3ujhd5hd92ff0hdjdjd==</b></li>
